...
let ITokenJSONConfig = {
  "contract_name": "IToken",
  "code": "",
  "runtime_bytecode": "",
  ...
  "function_hashes": {
    ...
    "getCheckpointCount(address)": "a97e8514",
    "name()": "06fdde03",
...
;
let IToken = new EmbarkJS.Contract(ITokenJSONConfig);

__embarkContext.execWhenReady(function() {

IToken.setProvider(web3.currentProvider);
